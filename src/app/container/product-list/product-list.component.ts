...
export class ProductListComponent {
  ...
  products = [
	...
	totalProductInstock = this.products.filter((product) => product.is_in_inventory).length;
	totalProductOutofstock = this.products.filter((product) => !product.is_in_inventory).length;
